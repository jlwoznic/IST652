...
search_wordsList = ["@FLGaming", "#FingerLakesRaceTrack", "@racingwrongs", "@HR_Nation", 
                    "@TheNYRA", "@NYSGamingComm", "@NYRBets", "@SireStakesNY"]
...
# Assuming they were "late to twitter" - run 1/2019 through present day
...
tweets_to_return = 200
search_wordsList = ["#aqueductracetrack", "@BDRacetrack", "#belmontpark", "@BelmontStakes", "@BufffaloRaceway",
                    "#buffaloraceway", "@FLGaming", "#fingerlakesracetrack", "#monticelloraceway",
                    "@gotiogadowns", "#tiogadowns", "@governondowns", "#vernondowns",
                    "@YonkersRaceway", "#yonkersraceway", "@racingwrongs", "@HR_Nation", 
                    "@TheNYRA", "@NYSGamingComm", "@NYRBets", "@trotinsider", "#harnessracing"]
...
tweets_pd = tweets_to_pd(tweet_list)
