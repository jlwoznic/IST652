...
for search_words in search_wordList:
    print(search_words)
...
tweets_to_return = 200
search_words = "@racingwrongs"
date_since = "2019-01-01"
date_until = "2020-05-22"
dbname = "racetestdb"
collname = "racetestcoll"
...
# less than 10 RT
print_tweet_dataLT(tweet_list)
# more than 100 RTG
print_tweet_dataGT(tweet_list)


# could use this to loop through dates (+/- 5 days), track and db and collection
tweets_to_return = 200
search_words = "#murderhornets"
