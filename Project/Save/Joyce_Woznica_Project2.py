...
# plot with seaborn
fg = sns.factorplot(x = "RaceType", y = "Infractions", hue = "RaceType", dodge=False,
                    size = 3, aspect = 2, palette="Set1", kind="bar", data=rulingsDFbyType)
...
# plot with seaborn
fg = sns.factorplot(x = "FullName", y = "Infractions", hue = "FullName", dodge=False,
                    size = 6, aspect = 2, palette="Spectral", kind="bar", data=shortrulingsDFbyName)
fg.set_xticklabels(rotation = 45, horizontalalignment = 'right', 
                         fontweight = 'light', fontsize = 'medium')
...
# plot with seaborn
fg = sns.factorplot(x = "Occupation", y = "Infractions", hue = "Occupation", dodge=False,
                    size = 6, aspect = 2, palette="RdBu", kind="bar", data=shortrulingsDFbyOccupation)
fg.set_xticklabels(rotation = 45, horizontalalignment = 'right', 
                         fontweight = 'light', fontsize = 'medium')
...
# plot with seaborn
fg = sns.factorplot(x = "FullName", y = "TotalFines", hue = "Occupation", dodge=False,
                    size = 6, aspect = 2, palette="Dark2", kind="bar", data=tFinesbyFNODF)
fg.set_xticklabels(rotation = 45, horizontalalignment = 'right', 
...
fg = sns.catplot(x = "Occupation", y = "AvgFine", hue = "Occupation", dodge=False,
                    height = 6, aspect = 2, palette="Dark2", kind="bar", data=avgFinebyOccDF)
fg.set_xticklabels(rotation = 45, horizontalalignment = 'right', 
                         fontweight = 'light', fontsize = 'small')
fg.set(xlabel = "Occupation", ylabel = "Average Fines", title = "Average Fine by Occupation from 2009-2019")

###---------- Analysis: Question 8 (TO DO) ------------
# Question 8: Average Fine by Year
